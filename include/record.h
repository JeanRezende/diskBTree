...
{
public:
    //tamanho minimo e maximo da arvore
...
template <class T> //criacao de um record padrao
...
template <class T> //criacao de um record a partir de outro(copia)
...
template <class T> //sobrecarga de operador =
...
template <class T> //desserializando
